import { CategoryJobListItemResponse, FindAllCategoriesResponse } from "src/application/dto/response/category/findAll.response";
...
export class CategoryMapper {
    ...
    static toFindAllResponse(entity: CategoryEntity): FindAllCategoriesResponse {
        const jobs = (entity.jobs ?? []).map((job) => CategoryMapper.toJobListItem(job));
